...
export default function LandingPage({ onEnterStaff, onEnterPatient }: LandingPageProps) {
  ...
  const galleryImages = [
    ...
    {
      url: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=400&auto=format&fit=crop&q=80",
      title: "Consultório de Especialidades"
    },
    {
      url: "https://images.unsplash.com/photo-1516549655169-df83a0774514?w=400&auto=format&fit=crop&q=80",
      title: "Equipamentos de Diagnóstico Modernos"
    },
    {
  ...
  const localDoctors: Doctor[] = [
    ...
    },
    {
      ...
      specialty: "Pediatria Integrada",
      crm: "CRM 54321-SP",
      bio: "Dedicada ao cuidado infantil humanizado, com foco no desenvolvimento integral e saúde preventiva do bebê.",
      image_url: "https://images.unsplash.com/photo-1594824813573-246434e33963?auto=format&fit=crop&q=80&w=300&h=300",
      availability: ["Ter", "Qui"]
    },
    {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 min-h-screen text-[#2D3748] dark:text-gray-100 font-sans antialiased text-base selection:bg-[#00A896] selection:text-white transition-colors duration-300">
      ...
      {/* HEADER FIXO */}
      <header className="fixed top-0 left-0 right-0 h-20 bg-white/95 dark:bg-slate-900/95 shadow-sm border-b border-gray-150 dark:border-slate-800 backdrop-blur-md z-50 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2.5 cursor-pointer" onClick={() => scrollToSection('home')}>
            <LogoIcon />
            <div>
              <span className="font-display font-bold text-xl tracking-tight text-[#028090]">Vida</span>
              <span className="font-display font-light text-xl tracking-tight text-[#2D3748] dark:text-gray-100 ml-0.5">Plena</span>
            </div>
          </div>

          {/* Navegação Desktop */}
          <nav className="hidden xl:flex items-center space-x-6 lg:space-x-8">
            <button onClick={() => scrollToSection('home')} className="font-bold text-[#2D3748]/80 dark:text-gray-200 hover:text-[#00A896] dark:hover:text-[#00A896] transition-colors cursor-pointer text-sm">Home</button>
            <button onClick={() => scrollToSection('especialidades')} className="font-bold text-[#2D3748]/80 dark:text-gray-200 hover:text-[#00A896] dark:hover:text-[#00A896] transition-colors cursor-pointer text-sm">Especialidades</button>
            ...
            <button onClick={() => scrollToSection('sobre')} className="font-bold text-[#2D3748]/80 dark:text-gray-200 hover:text-[#00A896] dark:hover:text-[#00A896] transition-colors cursor-pointer text-sm">Sobre Nós</button>
            <button onClick={() => scrollToSection('galeria')} className="font-bold text-[#2D3748]/80 dark:text-gray-200 hover:text-[#00A896] dark:hover:text-[#00A896] transition-colors cursor-pointer text-sm">Galeria</button>
            <button onClick={() => scrollToSection('equipe')} className="font-bold text-[#2D3748]/80 dark:text-gray-200 hover:text-[#00A896] dark:hover:text-[#00A896] transition-colors cursor-pointer text-sm">Equipe Médica</button>
            <button onClick={() => scrollToSection('contato')} className="font-bold text-[#2D3748]/80 dark:text-gray-200 hover:text-[#00A896] dark:hover:text-[#00A896] transition-colors cursor-pointer text-sm">Contato</button>
          </nav>
          ...
          <div className="hidden xl:flex items-center space-x-3">
            ...
            <button 
              ...
              className="px-5 py-2.5 text-xs font-black text-[#028090] bg-[#E0F2F1] border border-[#00A896]/15 hover:bg-[#00A896] hover:text-white tracking-wide rounded-xl transition-all font-bold cursor-pointer"
            >
              Área do Paciente
            </button>
              ...
              >
                ...
                <div className="flex items-center justify-between pb-6 border-b border-slate-100 dark:border-slate-800">
                  <div className="flex items-center space-x-2.5">
                    <LogoIcon />
                    <div>
                      <span className="font-display font-bold text-lg text-[#028090]">Vida</span>
                      <span className="font-display font-light text-lg text-[#2D3748] dark:text-gray-100 ml-0.5">Plena</span>
                    </div>
                  </div>
                  <button
                    onClick={() => setMobileMenuOpen(false)}
                ...
                <div className="flex-1 overflow-y-auto py-6 space-y-1 pr-1">
                  ...
                  <button 
                    onClick={() => { setMobileMenuOpen(false); scrollToSection('galeria'); }} 
                    className="block w-full text-left font-bold py-3 px-3 rounded-xl text-slate-700 dark:text-gray-200 hover:text-[#00A896] hover:bg-[#E0F2F1]/30 dark:hover:bg-slate-800/50 transition-colors text-sm"
                  >
                    Galeria
                  </button>
                ...
                <div className="pt-6 border-t border-slate-100 dark:border-slate-800 space-y-3">
                  ...
                  <button 
                    ...
                    className="w-full text-center py-3 rounded-xl text-xs font-black text-[#028090] bg-[#E0F2F1] border border-[#00A896]/15 hover:bg-[#00A896] hover:text-white transition-all cursor-pointer font-bold duration-250"
                  >
                    Área do Paciente
                  </button>
                  <button 
                    onClick={() => { setMobileMenuOpen(false); onEnterStaff(); }}
      ...
      {/* HERO SECTION */}
      <section id="home" className="pt-32 pb-20 md:py-40 bg-gradient-to-br from-[#E0F2F1]/30 to-white dark:from-slate-900/40 dark:to-slate-950 overflow-hidden relative">
        <div className="absolute inset-0 bg-cover bg-center mix-blend-overlay opacity-10 dark:opacity-5" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1504813184591-015556c5c522?w=1600&auto=format&fit=crop&q=80')" }}></div>
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-8 py-4 text-sm font-bold text-[#028090] dark:text-[#5cecdb] bg-white dark:bg-slate-900 hover:bg-[#E0F2F1]/30 dark:hover:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-800 transition-all cursor-pointer"
                >
              ...
              {/* Badges de Confiança */}
              <div className="pt-6 grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0 text-center border-t border-gray-200/50 dark:border-slate-800">
                <div>
                  <h4 className="font-display font-black text-2xl text-[#028090] dark:text-[#00c9b4]">15K+</h4>
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold tracking-wider">Atendimentos</p>
                </div>
                <div>
                  <h4 className="font-display font-black text-2xl text-[#028090] dark:text-[#00c9b4]">100%</h4>
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold tracking-wider">Médico Logado</p>
                </div>
                <div>
                  <h4 className="font-display font-black text-2xl text-[#028090] dark:text-[#00c9b4]">24h</h4>
                  <p className="text-[10px] text-gray-500 dark:text-gray-400 uppercase font-bold tracking-wider">Prontuário Seguro</p>
                </div>
              </div>
            </div>

            {/* Imagem do Hero com frame */}
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative w-full max-w-md aspect-square md:aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-4 border-white dark:border-slate-800 transform hover:rotate-1 transition-all duration-350">
                <div className="absolute inset-0 bg-gradient-to-t from-[#028090]/80 via-transparent to-transparent z-10"></div>
                <img 
                  src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=600&auto=format&fit=crop&q=80" 
                  alt="Dra e Paciente sorrindo" 
                  className="w-full h-full object-cover"
                  referrerPolicy="no-referrer"
                />
                <div className="absolute bottom-6 left-6 right-6 z-20 text-white">
                  <span className="text-[10px] font-bold tracking-wider uppercase text-white bg-[#00A896] backdrop-blur-md px-3 py-1 rounded-full">Prêmio Excelência Saúde 2026</span>
                  <h3 className="font-display font-black text-lg md:text-xl mt-2">Tecnologia avançada a favor do seu bem-estar.</h3>
                </div>
              </div>
              
              {/* Card Flutuante de Alerta */}
              <div className="absolute -bottom-4 -left-4 md:-left-8 bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-xl flex items-center space-x-3 max-w-xs border border-slate-100 dark:border-slate-800 z-30">
                <div className="w-10 h-10 bg-[#E0F2F1] dark:bg-[#00A896]/20 rounded-xl flex items-center justify-center text-[#00A896]">
                  <Clock className="w-5 h-5 stroke-[2.5]" />
                </div>
                <div>
                  <h5 className="font-black text-xs text-[#2D3748] dark:text-gray-100">Resultados Rápidos</h5>
                  <p className="text-[11px] text-gray-500 dark:text-gray-400 font-medium">Histórico clínico e prontuários online liberados na hora.</p>
                </div>
              </div>
            </div>
            ...
            {specialties.map((spec, i) => (
              ...
              >
                <div className="w-12 h-12 bg-[#E0F2F1] dark:bg-[#00A896]/25 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-[#00A896] group-hover:text-white transition-all duration-300">
                  <div className="text-[#00A896] group-hover:text-white">
                    {spec.icon}
                  </div>
                </div>
      ...
      <section id="sobre" className="py-24 bg-white dark:bg-slate-950 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white dark:bg-slate-900 border border-[#E0F2F1] dark:border-slate-800 rounded-2xl p-4 shadow-xl flex items-center gap-3 z-20">
                ...
                <div>
                  <p className="text-xs font-black text-[#028090] leading-none uppercase">ISO 9001</p>
            ...
            <div className="lg:col-span-7 space-y-6">
              <span className="text-[#00A896] uppercase text-xs font-bold tracking-widest block">Sobre Nós</span>
              ...
              <div className="pt-6">
                <button
                  onClick={onEnterPatient}
                  className="px-6 py-3 rounded-xl text-xs font-bold text-white bg-[#00A896] hover:bg-[#028090] transition-colors focus:ring-4 focus:ring-[#00A896]/20 cursor-pointer"
                >
                  Criar minha conta / Acessar Portal
                </button>
              </div>
            </div>
      ...
      {/* GALERIA DE FOTOS */}
      <section id="galeria" className="py-24 bg-[#E0F2F1]/20 dark:bg-slate-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-16">
            <h2 className="text-[#00A896] uppercase text-xs font-bold tracking-widest">Nossa Estrutura</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {galleryImages.map((img, idx) => (
              <div 
                key={idx}
                className="group relative rounded-2xl overflow-hidden aspect-[4/3] border border-slate-100 dark:border-slate-800 shadow-md bg-slate-50 dark:bg-slate-900 cursor-pointer"
              >
                <img 
                  src={img.url} 
                  alt={img.title}
                  ...
                  referrerPolicy="no-referrer"
                />
                <div className="absolute inset-0 bg-[#028090]/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="w-10 h-10 bg-white text-[#028090] rounded-full flex items-center justify-center shadow-lg">
                    <Heart size={18} fill="#00A896" stroke="none" />
                  </div>
                </div>
              </div>
            ))}
      ...
      <section id="depoimentos" className="py-24 bg-white dark:bg-slate-950 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* CONTATO SECTION */}
      <section id="contato" className="py-24 bg-[#E0F2F1]/15 dark:bg-slate-900/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center max-w-3xl mx-auto space-y-3 mb-16">
            <h2 className="text-[#00A896] uppercase text-xs font-bold tracking-widest block">Atendimento</h2>
            <h2 className="font-display font-black text-3xl sm:text-4xl text-[#028090] dark:text-white">Fale Conosco</h2>
            <p className="text-sm font-medium text-slate-500 dark:text-gray-350 mt-2">
              Tem dúvidas sobre convênios aceitos, especialidades ou exames específicos? Estamos aqui para te ajudar.
            </p>
          </div>

          <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[32px] shadow-xl p-8 sm:p-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 text-center md:text-left">
              
              {/* Endereço */}
              <div className="space-y-4">
                <div className="w-12 h-12 bg-[#E0F2F1] dark:bg-[#00A896]/15 text-[#00A896] rounded-2xl flex items-center justify-center mx-auto md:mx-0">
                  <MapPin className="w-6 h-6 stroke-[2.5]" />
                </div>
                <div>
                  <h4 className="font-display font-black text-base text-[#028090] dark:text-white">Localização</h4>
                  <p className="text-xs sm:text-sm text-gray-650 dark:text-gray-300 mt-2 font-semibold">
                    Av. Paulista, 1200 - Conj. 50 • Bela Vista<br />São Paulo - SP • CEP: 01310-100
                  </p>
                  <p className="text-[11px] text-[#00A896] font-bold mt-2">Estação Trianon Masp a 200m</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-display font-black text-base text-[#028090] dark:text-white">Telefones</h4>
                  <p className="text-xs sm:text-sm text-gray-650 dark:text-gray-300 mt-2 font-semibold">
                    <strong>Fixo:</strong> (11) 3244-1020
                  </p>
                  <p className="text-xs sm:text-sm text-[#00A896] font-extrabold mt-1">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-display font-black text-base text-[#028090] dark:text-white">E-mail & Horário</h4>
                  <p className="text-xs sm:text-sm text-gray-650 dark:text-gray-300 mt-2 font-semibold truncate" title="contato@vidaplenaclinica.com">
                    contato@vidaplenaclinica.com
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 leading-relaxed">
                    <strong>Segunda a Sexta:</strong> 08h às 18h<br />
                    <strong>Sábados:</strong> 08h às 12h
                  </p>
                </div>
              </div>
            ...
            {/* Mock map ambient display at the bottom of the card for visual balance */}
            <div className="mt-12 h-44 sm:h-52 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 relative group bg-slate-50 dark:bg-slate-950/50 shadow-inner">
              <div className="absolute inset-0 bg-[#E0F2F1] opacity-5 mix-blend-color-burn" />
              <div className="absolute top-6 left-6 z-10 text-slate-800 dark:text-white">
                <div className="px-3 py-1 rounded-xl bg-[#028090] text-white text-[10px] font-bold uppercase tracking-wider shadow-md">
                  Avenida Paulista, SP
                </div>
              </div>
              
              {/* Visual grid representing map lines */}
              <div className="absolute inset-0 z-0 bg-[radial-gradient(#00a896_1px,transparent_1px)] [background-size:24px_24px] opacity-10 dark:opacity-20" />
              <div className="absolute inset-0 z-0 bg-[linear-gradient(to_right,rgba(0,168,150,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,168,150,0.05)_1px,transparent_1px)] bg-[size:48px_48px]" />
              
              {/* Map pin with radar animation */}
              <div className="absolute left-1/2 top-1/2 -ml-4 -mt-4 z-10 flex flex-col items-center">
                <div className="relative">
                  <div className="absolute -inset-4 bg-[#FF6B35]/20 rounded-full animate-ping duration-1000" />
                  <div className="absolute -inset-8 bg-[#FF6B35]/5 rounded-full animate-ping duration-2000" />
                  <div className="w-8 h-8 rounded-full bg-[#FF6B35] flex items-center justify-center ring-4 ring-white dark:ring-slate-900 shadow-lg">
                    <MapPin size={16} className="text-white" />
                  </div>
                </div>
                <span className="mt-2 text-[9px] font-black uppercase text-slate-700 dark:text-gray-300 tracking-wider bg-white/95 dark:bg-slate-900 border border-slate-150 dark:border-slate-800 px-2.5 py-1 rounded-lg shadow-sm">
                  Clínica Vida Plena
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-[#00A896]/20 dark:border-slate-800">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <div className="text-white">
                  <span className="font-display font-bold text-xl tracking-tight">Vida</span>
                  <span className="font-display font-light text-xl tracking-tight ml-0.5">Plena</span>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-xs text-[#E0F2F1] dark:text-gray-300 font-bold">
                ...
                <li><button onClick={() => scrollToSection('galeria')} className="hover:text-[#FF6B35] transition-colors cursor-pointer text-left">Nossa Galeria</button></li>
                <li><button onClick={() => scrollToSection('equipe')} className="hover:text-[#FF6B35] transition-colors cursor-pointer text-left">Corpo Clínico</button></li>
              </ul>
            </div>

            {/* Coluna 3: Endereço & Mapa */}
            <div className="space-y-4">
              ...
              {/* Styled Mock Sandbox Map container */}
              <div className="w-full h-24 rounded-2xl overflow-hidden border border-white/10 relative group bg-indigo-950/20 shadow-inner">
                <div className="absolute inset-0 bg-[#E0F2F1] opacity-5 mix-blend-color-burn" />
                <div className="absolute inset-0 p-2 flex flex-col justify-between z-10 text-white">
                  <div className="px-1.5 py-0.5 rounded bg-[#028090] border border-white/10 text-[8px] font-bold self-start uppercase tracking-wider">
                    Bela Vista
                  </div>
                  <div className="text-[9px] font-bold text-[#E0F2F1]/90 flex items-center gap-1">
                    <span>Estação Trianon Masp a 200m</span>
                  </div>
                </div>
                {/* Visual grid representing map lines */}
                <div className="absolute inset-0 z-0 bg-[radial-gradient(#ffffff_1px,transparent_1px)] [background-size:16px_16px] opacity-15" />
                <div className="absolute w-2 h-2 rounded-full bg-[#FF6B35] left-1/2 top-1/2 -ml-1 -mt-1 ring-4 ring-white animate-ping" />
              </div>
            </div>
