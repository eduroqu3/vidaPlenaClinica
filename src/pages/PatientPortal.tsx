      ...
      <header className="bg-white dark:bg-[#111c24] border-b border-slate-100 dark:border-slate-800 sticky top-0 z-50 transition-colors">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 bg-[#E0F2F1] dark:bg-[#028090]/20 rounded-xl flex items-center justify-center text-[#00A896]">
              <LogoIconPatient />
            </div>
            <div>
              <div className="flex items-baseline">
                <span className="font-extrabold font-heading text-base tracking-tight text-[#028090]">Vida</span>
                <span className="font-light text-base tracking-tight ml-0.5 text-[#2D3748] dark:text-slate-300">Plena</span>
              </div>
              <p className="text-[9px] text-[#00A896] font-extrabold uppercase tracking-widest leading-none mt-0.5">Portal do Paciente</p>
            </div>
          </div>
